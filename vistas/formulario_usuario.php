  ...
  <div class="min-h-screen flex justify-center items-center px-4 py-10">
    ...
    <div class="flex-1 p-8 lg:p-12">
      ...
      <form action="../controladores/insertar_usuario.php" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700">Nombre(s)<span class="text-red-500 text-2xl">*</span></label>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700">Apellido Paterno<span class="text-red-500 text-2xl">*</span></label>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700">CURP<span class="text-red-500 text-2xl">*</span></label>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700">Fecha de Nacimiento<span class="text-red-500 text-2xl">*</span></label>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700">Sexo<span class="text-red-500 text-2xl">*</span></label>
        ...
        <div class="md:col-span-2">
          <label class="block text-sm font-medium text-gray-700">Correo Electrónico<span class="text-red-500 text-2xl">*</span></label>
        ...
        <!-- Contraseña -->
        <div>
          <label class="block text-sm font-medium text-gray-700">Contraseña<span class="text-red-500 text-2xl">*</span></label>
        ...
        <!-- Confirmar Contraseñ -->
         <div>
          <label class="block text-sm font-medium text-gray-700">Confirmar Contraseña<span class="text-red-500 text-2xl">*</span></label>
          <input type="password" name="confirmarPass" placeholder="De 8 a 20 caracteres" minlength="8" maxlength="20" required
            class="w-full mt-1 p-2 border rounded-md focus:outline-[#4F0087]">
        </div>

        <div>
          <label class="block text-sm font-medium text-gray-700">Rol<span class="text-red-500 text-2xl">*</span></label>
        ...
        <div class="md:col-span-2">
          <label class="block text-sm font-medium text-gray-700">Foto de Usuario<span class="text-red-500 text-2xl">*</span></label>
