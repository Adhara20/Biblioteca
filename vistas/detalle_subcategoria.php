...
<body class="bg-gray-100 text-gray-900">
  ...
  <?php
  include('../clases/subcategoria.php');//Incluyes la clase
  $clase = new Subcategoria();//creas instacia
  ...
  <div class="w-full max-w-5xl bg-white shadow-lg rounded-2xl p-8 border border-gray-300 mb-12 mx-auto flex flex-col md:flex-row-reverse gap-8">
    ...
    <div class="flex-shrink-0 w-full md:w-1/3 flex justify-center items-start">
      <img 
        src="<?= $imgRuta ?>" 
        alt="Icono de <?= htmlspecialchars($fila['iconoSubCategoria']) ?>" 
    ...
    <div class="flex-1">
      <div class="mb-6 text-center md:text-left">
        <h2 class="text-2xl font-semibold text-[#4F0087]"><?= $fila['nombreSubCategoria'] ?></h2><!--El nombre o codigo de lo que les tocó. En algunos casos, dependiendo, pueden omitirlo--> 
      ...
      <div class="border-t border-gray-300 pt-4">
        <dl class="divide-y divide-gray-200">
          ...
          <div class="py-3 grid grid-cols-3 gap-4">
            ...
            <div class="py-3 grid grid-cols-3 gap-4">
            <dt class="font-medium text-gray-700">Abreviarura:</dt>
            <dd class="col-span-2 text-gray-800"><?= $fila['abreviatura'] ?></dd>
          </div>
      ...
      <?php if($rol != 'L' && $estatusLog == 'A'):  ?>
        ...
        <?php
          if($fila['estatus'] == 'A'){
        ?>
          <a href="../controladores/desactivar_subcategoria.php?pkSubCategoria=<?= $fila['pkSubCategoria'] ?>" class="px-4 py-2.5 rounded-md text-white font-medium transition
        ...
        ?> 
          <a href="../controladores/activar_subcategoria.php?pkSubCategoria=<?= $fila['pkSubCategoria'] ?>" class=" px-4 py-2.5 rounded-md text-white font-medium transition
