...
<?php if($rol !='L' && $estatusLog =='A'): ?>
      ...
      <div class="flex justify-end gap-3 mt-8">
        ...
        <?php
          if($fila['estatus'] == 'A'){
        ?>
          <a href="../controladores/desactivar_categoria.php?pkCategoria=<?= $fila['pkCategoria'] ?>" class="px-4 py-2.5 rounded-md text-white font-medium transition
        ...
        ?>
          <a href="../controladores/activar_categoria.php?pkCategoria=<?= $fila['pkCategoria'] ?>" class=" px-4 py-2.5 rounded-md text-white font-medium transition
