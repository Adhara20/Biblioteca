    ...
    <?php if($rol != 'L' && $estatusLog == 'A'){ ?>
      ...
      <?php
        ...
        ?>      
                                                                                              <!-- class="px-4 py-2.5 rounded-md font-medium transition border border-[#5780B5] text-[#5780B5] bg-blue-200 
                                                                                              hover:bg-[#5780B5] hover:text-blue-200  shadow-sm"> -->
          <a href="../controladores/desactivar_nacionalidad.php?pkNacionalidad=<?= $fila['pkNacionalidad'] ?>" class="px-4 py-2.5 rounded-md text-white font-medium transition bg-[#B55780] hover:bg-[#e5b6ca] hover:text-[#B55780] border hover:border-[#B55780] shadow-sm">
            Desactivar
          </a>
        <?php
          }else{
        ...
        <!-- Nomas le acomodan el nombre del controlador -->
          <a href="../controladores/activar_nacionalidad.php?pkNacionalidad=<?= $fila['pkNacionalidad'] ?>" class=" px-4 py-2.5 rounded-md text-white font-medium transition
