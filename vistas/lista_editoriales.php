...
<div class="px-10 mb-6">
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center">
      <a href="formulario_editorial.php" class="rounded-md text-white font-medium transition bg-[#5780B5] hover:bg-[#6b92c2] shadow-sm px-4 py-2 w-full sm:w-40 text-center">
        Agregar Editorial
      </a>
    </div>
  </div>
